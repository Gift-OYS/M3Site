def get_max_length(col, config):
    if col == 'Protein names' or col == 'Entry Name':
        return 48
    if col == 'Organism':
        return 24
    if col == 'Taxonomic lineage':
        return 128
    if col == 'Function' or col == 'Function [CC]':
        return 128
    if col == 'Caution':
        return 72
    if col == 'Miscellaneous' or col == 'Miscellaneous [CC]':
        return 64
    ...
    if col == 'Developmental stage':
        return 64
    if col == 'Allergenic properties' or col == 'Allergenic Properties':
        return 48
    ...
    if col == 'Involvement in disease':
        return 256
    if col == 'Subcellular location' or col == 'Subcellular location [CC]':
        return 64
...
def get_col_name_list(brief=True):
    if brief:
